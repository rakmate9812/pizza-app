<template>
  <v-container class="home-page pa-5 text-center">
    <v-row>
      <v-col>
        <h1 class="display-2">
          Welcome to Pizza'ed: Your Ultimate Pizza Adventure!
        </h1>
        <h2 class="subtitle-1">
          🍕 Craving the perfect slice? You're in the right place! 🍕
        </h2>
        <p class="body-1">
    ...
    <v-row class="mt-10">
      <v-col>
        ...
        <p class="body-1">
          Every pizza lover has a unique story to tell, and the world want to
          hear yours! Introducing a user-friendly upload feature that allows you
          to share your pizza adventures with the Pizza'ed community.
        </p>
      </v-col>
    </v-row>
  </v-container>
